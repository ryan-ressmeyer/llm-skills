...
All scripts include PEP 723 inline metadata — dependencies are installed automatically via `uv run`. No manual installation needed.

Run any script with:
```bash
uv run /path/to/citation-management/scripts/script_name.py [args]
```
